...
# Experimental A13 checkpoint published with this branch. tools/test.py
# overrides this value when an explicit checkpoint argument is supplied.
load_from = './results/MMR_AD_A13_Hin_rtm_v2_NearestMem/epoch_9.pth'
